...
try:
    if st.session_state['authenticator'].register_user('Registrar Usuario', preauthorization=False):
        st.success('Usuario registrado exitosamente!')
        #with open('secrets/config.yaml','w') as filen:
        #    yaml.dump(config,filen, default_flow_style=False)
        #switch_page('login')
